...
class ConfigHandler {
    ...
    fun generateDefaultConfig(config: FileConfiguration) {
        ...
        config.setComments("base-speed", listOf(
        ...
        config.setComments("default-speed", listOf(
        ...
        config.setComments("always-affect-tamed-ghasts", listOf(
        ...
        config.setComments("affect-untamed-happy-ghasts", listOf(
